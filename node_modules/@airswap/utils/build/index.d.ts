...
export declare function toDecimalString(value: string | BigNumber, decimals: string | number): string;
export declare function toAtomicString(value: string | BigNumber, decimals: string | number): string;
export declare function getTimestamp(): string;
export declare function parseUrl(locator: string): url.UrlWithStringQuery;
export declare function getEtherscanURL(chainId: string, hash: string): string;
